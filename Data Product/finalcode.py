...
# disregard opponent information and specific tackle types
    # (for further information/justification about exclusions refer to ReadMe or Jupyter notebook)  
...
# list of variables to remove 
    # (for further information/justification about variables being removed refer to ReadMe or Jupyter notebook) 
...
columns_to_drop = ['TackleCharacteristics', 'Index', '_1', '_2', '_9', '_10', '_13']
